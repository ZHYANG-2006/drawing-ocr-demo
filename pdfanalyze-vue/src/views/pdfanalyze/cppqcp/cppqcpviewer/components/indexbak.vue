...
<script setup>
  ...
  import OCRContent from './rescomp/OCRContent.vue';
  import OCRContentCH from './chcomp/OCRContentCH.vue';
  import ReviewTable from './reviewcomp/ReviewResultTable.vue';
  import { useRoute } from 'vue-router';
  import { useFileStore } from '/src/views/pdfanalyze/cppqcp/stores/fileStore.js';
  import {
    getJson,
    getPDF,
  } from '/src/views/pdfanalyze/cppqcp/api/viewer/viewer.js';
