...
<script setup lang="jsx">
  ...
  import {
    ...
    getList,
    getTask,
  } from '/@/views/pdfanalyze/cppqcp/api/cppqcpfile/pdfFile.js';
  import { message, Modal } from 'ant-design-vue';
  import { createReview } from '/@/views/pdfanalyze/cppqcp/api/cppqcpvreview/reviewversion.js';
  ...
  const columns = [
      ...
      title: () => (
        <div style="text-align: center;">
          ...
          <a-input
            placeholder=""
            style="width: 60px; height: 20px;"
            value={filterValue.file_type}  // 绑定值
            onInput={e => {
    ...
    },
    {
      ...
      width: 100,
      sorter: (a, b) => {
        return a.is_universal.localeCompare(b.is_universal);
      },
    },
    {
      title: () => (
    ...
    },
    {
      ...
      width: 110,
      sorter: (a, b) => {
        return a.pfmea_type.localeCompare(b.pfmea_type);
      },
    },
    {
      title: () => (
        <div style="text-align: center;">
          ...
          <a-input
            placeholder=""
            style="width: 60px; height: 20px;"
            value={filterValue.value.branch}  // 绑定值
            onInput={e => {
              filterValue.value.branch = e.target.value;
              debouncedFetchPdfFiles();
            }} // 更新 filterValue
            onClick={(e) => e.stopPropagation()}  // 防止点击时触发排序
          />
      ...
      title: () => (
        <div style="text-align: center;">
          ...
          <a-input
            ...
            onInput={e => {
              filterValue.value.name = e.target.value;
              debouncedFetchPdfFiles();
            }} // 更新 filterValue
            onClick={(e) => e.stopPropagation()}  // 防止点击时触发排序
          />
      ...
      title: () => (
        <div style="text-align: center;">
          ...
          <a-input
            placeholder=""
            style="width: 60px; height: 20px;"
            value={filterValue.value.type}  // 绑定值
            onInput={e => {
              filterValue.value.type = e.target.value;
              debouncedFetchPdfFiles();
            }} // 更新 filterValue
            onClick={(e) => e.stopPropagation()}  // 防止点击时触发排序
          />
    ...
    },
    {
      title: () => (
        <div style="text-align: center;">
          <span style="display: block;">解析版本</span>
          <a-input
            placeholder=""
            style="width: 60px; height: 20px;"
            value={filterValue.value.analyze_version}  // 绑定值
            onInput={e => {
              filterValue.value.analyze_version = e.target.value;
              debouncedFetchPdfFiles();
            }} // 更新 filterValue
            onClick={(e) => e.stopPropagation()}  // 防止点击时触发排序
          />
      ...
      dataIndex: 'analyze_version',
      key: 'analyze_version',
      filterDropdownVisible: true,
      width: 100,
      sorter: (a, b) => {
        return a.analyze_version.localeCompare(b.analyze_version);
      },
    },
