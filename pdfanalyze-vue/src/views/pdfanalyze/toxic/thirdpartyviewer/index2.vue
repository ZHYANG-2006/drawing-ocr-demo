...
<script setup>
  ...
  import pdfPath from '/@/assets/SGS_HANPIN_COPPER FOIL_XPH SERIES_ROHS_HF_4P_Sb_Be_As_20190802.pdf';
  import jsonData from '/@/assets/SGS_HANPIN_COPPER FOIL_XPH SERIES_ROHS_HF_4P_Sb_Be_As_20190802.json';
  import {
    getJson,
    getPDF,
