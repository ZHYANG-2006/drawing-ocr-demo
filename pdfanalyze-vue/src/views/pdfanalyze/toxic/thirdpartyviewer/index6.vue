...
<script setup>
  ...
  import pdfPath from '/@/assets/SGS ANSHIXIN_Teflon TAPE_CJ-TJ  TJ Series BLACK_ROHS_HF_4P_20230422.pdf';
  import jsonData from '/@/assets/SGS ANSHIXIN_Teflon TAPE_CJ-TJ  TJ Series BLACK_ROHS_HF_4P_20230422.json';
  import {
    getJson,
    getPDF,
