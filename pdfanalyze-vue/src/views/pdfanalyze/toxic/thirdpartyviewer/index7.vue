...
<script setup>
  ...
  import pdfPath from '/@/assets/SGS_TAMURA_Solder mask_APB-280-32HR_RoHS_4P_20220826.pdf';
  import jsonData from '/@/assets/SGS_TAMURA_Solder mask_APB-280-32HR_RoHS_4P_20220826.json';
  import {
    getJson,
    getPDF,
