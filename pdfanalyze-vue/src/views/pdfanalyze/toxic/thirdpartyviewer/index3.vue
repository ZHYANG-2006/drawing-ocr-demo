...
<script setup>
  ...
  import pdfPath from '/@/assets/SGS_FUANDA_BLACK PC_ROHS_HF_4P_SB__20200413.pdf';
  import jsonData from '/@/assets/SGS_FUANDA_BLACK PC_ROHS_HF_4P_SB__20200413.json';
  import {
    getJson,
    getPDF,
