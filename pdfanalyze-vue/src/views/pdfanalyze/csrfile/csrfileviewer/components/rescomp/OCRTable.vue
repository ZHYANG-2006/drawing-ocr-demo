                      ...
                      <template v-else>
                        {{
                          ...
                          getCell(rowIndex, columnIndex)?.has_xbar
                            ? getCell(rowIndex, columnIndex)?.true_value
                            : getCell(rowIndex, columnIndex)?.value || ''
                        }}
                      </template>
                    </td>
                  </template>
...
<script setup>
  ...
  function getCellVirtual(rowIndex, columnIndex) {
    return (
      tableContent.value?.cells?.find(
        (cell) => cell.row_index === rowIndex && cell.col_index === columnIndex,
      ) || null
    );
  }
  ...
  function isSelected(rowIndex, columnIndex) {
    ...
    return (
      ...
      props.selectedContent.row_index === rowIndex &&
      props.selectedContent.col_index === columnIndex
    );
  }
