<template>
  <div class="home-container">
    <a-row :gutter="15" class="home-card-one mb15">
      <a-col
    ...
    <a-row :gutter="15" class="home-card-two mb15">
      <a-col :xs="24" :sm="14" :md="14" :lg="16" :xl="16">
        <div class="home-card-item">
          <div ref="homeLineRef" style="height: 100%"></div>
        </div>
      </a-col>
      <a-col :xs="24" :sm="10" :md="10" :lg="8" :xl="8" class="home-media">
        <div class="home-card-item">
          <div ref="homePieRef" style="height: 100%"></div>
        </div>
      </a-col>
    </a-row>
    <a-row :gutter="15" class="home-card-three">
      <a-col :xs="24" :sm="10" :md="10" :lg="8" :xl="8">
        <div class="home-card-item">
          <div class="home-card-item-title">快捷导航工具</div>
          <div class="home-monitor">
            <div class="flex-warp">
              <div v-for="(v, k) in homeThree" :key="k" class="flex-warp-item">
      ...
      <a-col :xs="24" :sm="14" :md="14" :lg="16" :xl="16" class="home-media">
        <div class="home-card-item">
    ...
    setup() {
      ...
      const initLineChart = () => {
        ...
        const option = {
          ...
          legend: { data: ['配置数据量', '核验数据量'], right: 0 },
          xAxis: {
            data: [
              '1月',
              '2月',
      ...
      // 饼图
      const initPieChart = () => {
        if (!global.dispose.some((b: any) => b === global.homeChartTwo))
          global.homeChartTwo.dispose();
        global.homeChartTwo = <any>(
          echarts.init(homePieRef.value, state.charts.theme)
        );
        var getname = ['APS', 'MES', 'AI', '大数据', 'Others'];
      ...
      // 柱状图
      const initBarChart = () => {
        if (!global.dispose.some((b: any) => b === global.homeCharThree))
          global.homeCharThree.dispose();
        global.homeCharThree = <any>(
        ...
        const option = {
          ...
          series: [
            ...
            },
            {
              ...
              data: [
                { value: 81, stationName: 's1' },
                { value: 56, stationName: 's2' },
                { value: 74, stationName: 's3' },
                { value: 84, stationName: 's4' },
                { value: 73, stationName: 's5' },
                { value: 42, stationName: 's6' },
              ],
            },
            {
              name: 'POK',
