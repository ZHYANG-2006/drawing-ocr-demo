<template>
  <div class="layout-columns-aside">
    <PerfectScrollbar
      ...
      @mouseenter="onColumnsAsideMenuMouseenter"
      @mouseleave="onColumnsAsideMenuMouseleave"
    >
      <a-list @mouseleave="onColumnsAsideMenuMouseleave()">
        <a-list-item
        ...
        >
          ...
          <a v-if="v.meta.isLink" :href="v.meta.isLink" target="_blank">
            <SvgIcon :name="v.meta.icon" />
            <div class="columns-vertical-title font12">
              {{
                $t(v.meta.title) && $t(v.meta.title).length >= 4
    ...
    (val) => {
      ...
      if (
        ...
        mittBus.emit(
          ...
          setSendChildren(state.liOldPath),
        );
      }
    },
    {
