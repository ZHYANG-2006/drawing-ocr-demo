...
class Role(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "sys_role"
        verbose_name = "角色表"
...
class Users(CoreModel, AbstractUser):
    ...
    class Meta:
        db_table = table_prefix + "sys_users"
        verbose_name = "用户表"
        verbose_name_plural = verbose_name
...
class Dept(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "sys_dept"
        verbose_name = "部门表"
        verbose_name_plural = verbose_name
        ordering = ("sort",)
...
class Menu(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "sys_menu"
        verbose_name = "菜单表"
        verbose_name_plural = verbose_name
        ordering = ("sort",)
...
class MenuField(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "sys_m_field"
        verbose_name = "菜单字段表"
        verbose_name_plural = verbose_name
        ordering = ("id",)
...
class FieldPermission(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "sys_fd_permi"
        verbose_name = "字段权限表"
        verbose_name_plural = verbose_name
        ordering = ("id",)
...
class MenuButton(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "sys_m_btn"
        verbose_name = "菜单权限表"
        verbose_name_plural = verbose_name
        ordering = ("-name",)
...
class RoleMenuPermission(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "r_m_permi"
...
class RoleMenuButtonPermission(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "r_m_btn_permi"
...
class Dictionary(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "sys_dict"
        verbose_name = "字典表"
        verbose_name_plural = verbose_name
        ordering = ("sort",)
...
class OperationLog(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "sys_opt_log"
        verbose_name = "操作日志"
        verbose_name_plural = verbose_name
        ordering = ("-create_datetime",)
...
class FileList(CoreModel):
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.file_url:
            self.file_url = f'media/{self.url}'
        super(FileList, self).save(*args, **kwargs)

    class Meta:
        db_table = table_prefix + "sys_f_lst"
        verbose_name = "文件管理"
        verbose_name_plural = verbose_name
        ordering = ("-create_datetime",)
...
class Area(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "sys_area"
        verbose_name = "地区表"
        verbose_name_plural = verbose_name
        ordering = ("code",)
...
class ApiWhiteList(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "api_wt_lst"
        verbose_name = "接口白名单"
        verbose_name_plural = verbose_name
        ordering = ("-create_datetime",)
...
class LoginLog(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "sys_lg_log"
        verbose_name = "登录日志"
        verbose_name_plural = verbose_name
        ordering = ("-create_datetime",)
...
class MessageCenter(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "msg_center"
        verbose_name = "消息中心"
        verbose_name_plural = verbose_name
        ordering = ("-create_datetime",)
...
class MessageCenterTargetUser(CoreModel):
    ...
    class Meta:
        db_table = table_prefix + "msg_ct_tg_usr"
        verbose_name = "消息中心目标用户表"
        verbose_name_plural = verbose_name


class LdapConfig(CoreModel):
    """
    LDAP
    """
    server_address = models.CharField(max_length=200, verbose_name="LDAP服务器地址", help_text="ldap服务器地址")
    username = models.CharField(max_length=200, verbose_name="LDAP管理员", help_text="ldap管理员")
    password = models.CharField(max_length=200, verbose_name="LDAP管理员密码", help_text="ldap管理员密码", null=True,
                                blank=True)
    login_field = models.CharField(max_length=200, verbose_name="LDAP登录验证字段", help_text="ldap登录验证字段")
    root = models.CharField(max_length=200, verbose_name="ROOT", help_text="ROOT")
    enabled = models.CharField(max_length=1, default='0', verbose_name="是否启用", help_text="是否启用")
    login_prefix = models.CharField(max_length=200, default='', verbose_name="登录前缀", help_text="登录前缀")
    login_suffix = models.CharField(max_length=200, default='', verbose_name="登录后缀", help_text="登录后缀")
    enc_password = models.CharField(max_length=200, verbose_name="加密密码", help_text="加密密码", null=True,
                                    blank=True)

    class Meta:
        db_table = table_prefix + "LDAP"  # 表名
        verbose_name = "LDAP配置表"
        verbose_name_plural = verbose_name
        ordering = ("id",)
