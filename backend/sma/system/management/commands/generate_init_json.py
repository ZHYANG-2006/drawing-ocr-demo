...
from sma.system.models.system import Menu, Users, Dept, Role, ApiWhiteList, Dictionary, SystemConfig
from sma.system.fixtures.initSerializer import UsersInitSerializer, DeptInitSerializer, RoleInitSerializer, \
